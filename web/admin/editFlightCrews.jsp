                ...
                <div class="mx-auto text-center loginfield">
                     <form action="AdminServlet">
                            <div class="form-group loginbutton-m-bot w-25 logininputs">
                                <input class="loginbuttoncolors" type="submit" value="Save Changes" name="flightCrewsSaveEditKnop"/>
                            </div>
                            <div class="form-group cancelbutton-m-bot w-25 logininputs">
                                <input class="loginbuttoncolors" type="submit" value="Cancel" name="flightCrewsCancelKnop"/>
                            </div>
                     </form>
                </div>
            </div>
